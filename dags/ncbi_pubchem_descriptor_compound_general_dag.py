...
@dag(default_args=default_args,
     dag_id="pubchem_descriptor_compound_general",
     tags=["ingestion", "ncbi_pubchem_descriptor_compound_general"],
...
def desc_compound_taskflow():
    """
    Download turtle files PubChem Descriptor Compound https://ftp.ncbi.nlm.nih.gov/pubchem/RDF/descriptor/compound/
    """

    @task(task_id="get_desc_compound_info")
    def get_desc_compound_info(**kwargs):
        from fonctions import http_download
        import re
        ti = kwargs['task_instance']
        version = ti.xcom_pull(key='return_value', task_ids='get_pubchem_version')

        listebrute = http_download("https://ftp.ncbi.nlm.nih.gov/pubchem/RDF/descriptor/compound/").decode('UTF-8')
        # "(a href=\"\S+\")"gm
        ...
        info = {"download_url": "https://ftp.ncbi.nlm.nih.gov/pubchem/RDF/descriptor/compound/",
                "version": version,
                "file_list": fichiers,
                "dir_name": get_dag_id(),
                "compression": "gz",
    ...
    get_pubchem_version >> get_desc_compound_info() >> check_and_ingest()


desc_compound_taskflow()
