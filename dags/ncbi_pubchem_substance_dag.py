...
@dag(default_args=default_args,
     dag_id="pubchem_substance",
     tags=["ingestion", "ncbi_pubchem_substance"],
     catchup=False,
     schedule="@weekly",
...
def pubchem_substance_taskflow():
    """
    Download pubchem substance from https://ftp.ncbi.nlm.nih.gov/pubchem/RDF/substance/
    """

    @task(task_id="get_pubchem_substance_info")
    def get_pubchem_substance_info(**kwargs):
        from fonctions import http_download
        import re
        ti = kwargs['task_instance']
        version = ti.xcom_pull(key='return_value', task_ids='get_pubchem_version')
        base_url = "https://ftp.ncbi.nlm.nih.gov/pubchem/RDF/substance/"
        ...
        info = {"download_url": base_url,
                "version": version,
                "file_list": fichiers,
                "written_file_name": "pubchem_substance",
                "compression": "gz",
                "dir_name": get_dag_id(),
    ...
    get_pubchem_version >> get_pubchem_substance_info() >> check_and_ingest()


pubchem_substance_taskflow()
